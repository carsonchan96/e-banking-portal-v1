...
import com.demo.ebankingportal.payload.requests.LoginRequest;
import com.demo.ebankingportal.payload.requests.SignupRequest;
...
// @Configuration
// @ComponentScan("com.demo.ebankingportal.services")
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "rm":
                        Role modRole = roleRepository.findByName(ERole.ROLE_RM)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
                        break;
                    default:
